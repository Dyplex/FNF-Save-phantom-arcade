	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'malicious-encounter':
				dialogue = CoolUtil.coolTextFile(Paths.txt('malicious-encounter/dialog'));
		}
		...
		switch(SONG.stage)
		{
			...
			case 'prison':
			{
						...
						var bg:FlxSprite = new FlxSprite(-830, -340).loadGraphic(Paths.image('prison/background'));
						bg.antialiasing = true;
						...
						phantomarcade = new FlxSprite(300, 250);
						...
						phantomarcade.antialiasing = true;
						if(FlxG.save.data.distractions){
						add(phantomarcade);
		...
		healthBar.createFilledBar(0xFFB8B8B8, 0xFF585858);
		// healthBar
		add(healthBar);
		...
		else
		{
			if (isStoryMode)
			{
				...
				if (storyPlaylist.length <= 0)
				{
					...
					if (SONG.song.toLowerCase() == 'malicious-encounter')
					{
						FlxG.switchState(new VideoState('assets/videos/last/last.webm', new MainMenuState()));
					}
					else
					{
